...
map.getView().fit([12725992.333196, -924963.494663, 12743152.579418, -913805.139161], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGis Tempat Wisata di Kecamatan Banyuwangi</h2>';
        return titleElement;
    })(),
